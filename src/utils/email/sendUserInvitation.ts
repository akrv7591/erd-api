...
export const sendUserInvitationEmail = (user: IUser) => {
  ...
  const mailOptions = {
    ...
    to: user.email,
    subject: 'Invitation to Collaborate on ERD Diagrams - Join Erdiagramly Now!',
    html: `
<!doctype html>
<html>
  <head>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="${verifyLink}" target="_blank">Accept invitation</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p>Thank you for considering Erdiagramly. We look forward to seeing you on our ERD Diagram Web App soon!</p>
                        <p>Best regards.</p>
                      </td>
                    </tr>
                  </table>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">https://akrv.dev</span>
                    <br> Don't like these emails? <a href="http://erdiagramly.akrv.dev">Unsubscribe</a>.
                  </td>
                </tr>
              </table>
            </div>
